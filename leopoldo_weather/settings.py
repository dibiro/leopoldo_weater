"""
Django settings for leopoldo_weather project.
...
ALLOWED_HOST = ['leopoldoweater-production.up.railway.app']
...
ROOT_URLCONF = 'leopoldo_weather.urls'
...
WSGI_APPLICATION = 'leopoldo_weather.wsgi.application'
